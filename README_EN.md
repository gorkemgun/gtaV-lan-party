...
Private lobbies are only marked as "Private" on matchmaking servers, so these lobbies are also not checked.
...
After adding these rules, we restart our server and make our VPN service ready.
